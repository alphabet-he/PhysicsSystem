...
GameObject* Engine::GameObjectFactory::CreateGameObject(const char* i_pJSONFileAddr)
{
...
void Engine::GameObjectFactory::RegisterControllerCreatorFunc(const std::string& i_ControllerType, std::function<void(GameObject&, nlohmann::json&)> i_ControllerCreatorFunc)
{
	ControllerCreators.insert({ i_ControllerType, i_ControllerCreatorFunc });
}

void Engine::GameObjectFactory::RegisterComponentCreatorFunc(const std::string& i_ComponentType, std::function<void(GameObject&, nlohmann::json&)> i_ComponentCreatorFunc)
{
