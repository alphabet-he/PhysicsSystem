...
inline void Engine::MovableSystem::Init()
{
	Engine::GameObjectFactory::RegisterComponentCreatorFunc("moveable", Engine::MovableSystem::CreateMoveableFromJSON);
};


inline void Engine::MovableSystem::CreateMoveableFromJSON(GameObject& go, nlohmann::json& jsonData)
{
...
inline void Engine::MovableSystem::CreateMovableComponent(GameObject& go, Point2D velocity, Point2D acceleration)
{
